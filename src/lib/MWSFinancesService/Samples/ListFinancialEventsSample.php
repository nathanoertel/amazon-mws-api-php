 ...
 * sample for List Financial Events Action
 ***********************************************************************/
 // @TODO: set request. Action can be passed as MWSFinancesService_Model_ListFinancialEvents
 $request = new MWSFinancesService_Model_ListFinancialEventsRequest();
 $request->setSellerId(MERCHANT_ID);
 // object or array of parameters
 invokeListFinancialEvents($service, $request);

/**
  * Get List Financial Events Action Sample
  * Gets competitive pricing and related information for a product identified by
  * the MarketplaceId and ASIN.
  *
  * @param MWSFinancesService_Interface $service instance of MWSFinancesService_Interface
  * @param mixed $request MWSFinancesService_Model_ListFinancialEvents or array of parameters
  */

  function invokeListFinancialEvents(MWSFinancesService_Interface $service, $request)
  {
      try {
