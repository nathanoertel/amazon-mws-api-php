 ...
 ***********************************************************************/
 // @TODO: set request. Action can be passed as MWSFinancesService_Model_GetServiceStatus
...
/**
  ...
  * @param mixed $request MWSFinancesService_Model_GetServiceStatus or array of parameters
  */

  function invokeGetServiceStatus(MWSFinancesService_Interface $service, $request)
  {
      try {
